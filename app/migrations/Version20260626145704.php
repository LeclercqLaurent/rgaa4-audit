...
/**
 * Refresh tokens JWT (gesdinet) : table refresh_tokens.
 */
final class Version20260626145704 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Refresh tokens JWT : table refresh_tokens.';
    }
